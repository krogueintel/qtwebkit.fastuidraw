...
if (CMAKE_BUILD_TYPE STREQUAL "Debug")
  pkg_check_modules(FASTUIDRAW_PK REQUIRED fastuidrawGL-debug)
else ()
  pkg_check_modules(FASTUIDRAW_PK REQUIRED fastuidrawGL-release)
endif ()

pkg_check_modules(FONTCONFIG_PK REQUIRED fontconfig)

set(FASTUIDRAW_CFLAGS ${FASTUIDRAW_PK_CFLAGS} ${FONTCONFIG_PK_CFLAGS})
set(FASTUIDRAW_LIBRARY_DIRS ${FASTUIDRAW_PK_LIBRARY_DIRS} ${FONTCONFIG_PK_LIBRARY_DIRS})
set(FASTUIDRAW_LIBRARIES ${FASTUIDRAW_PK_LIBRARIES} ${FONTCONFIG_PK_LIBRARIES})
