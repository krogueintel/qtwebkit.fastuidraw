...
public:
    ...
    static std::unique_ptr<ImageBuffer> createImageBuffer(const Settings *useFastUIDraw, const FloatRect& targetRect, const AffineTransform& absoluteTransform, ColorSpace, RenderingMode);
    static std::unique_ptr<ImageBuffer> createImageBuffer(const Settings *useFastUIDraw, const FloatRect& targetRect, const FloatRect& clampedRect, ColorSpace, RenderingMode);
